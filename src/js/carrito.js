    ...
    consolasSony.forEach((consolas, index) => {
        ...
        lista.innerHTML += `
            <div class="flex justify-between items-center border-b border-slate-700 py-4">
                <p class="font-bold">${consolas.Modelo}</p>
                <div class="flex items-center gap-4">
                    <span class="text-cyan-400 font-bold">$${consolas.Precio}</span>
...
lista.addEventListener("click", (e) => {
    ...
    if (boton) {
        ...
        consolasSony.setItem("carrito-mandos", JSON.stringify(consolasSony));
        mostrarCarrito();
    }
})
